...
namespace MvcWebSchool_Identity.Controllers
{
    public class AlunosController : Controller
    {
        private readonly WebSchoolContext _context;

        public AlunosController(WebSchoolContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Alunos != null ? 
                          ...
                          Problem("Entity set 'WebSchoolContext.Alunos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebSchoolContext.Alunos'  is null.");
            }
            var aluno = await _context.Alunos.FindAsync(id);
            if (aluno != null)
            {
